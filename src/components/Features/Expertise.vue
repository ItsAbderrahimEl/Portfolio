...
>
    ...
    import {expertises} from "../../../data/Expertise.ts"
...
<template>
    <Container>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-20 md:text-lg w-full">
            <template
                v-for="field in expertises"
                :key="field.id"
            >
                <div class="col-span-1 border border-gray-800 bg-secondary/10 p-5 rounded-lg">
                    ...
                    <div class="flex flex-wrap gap-3 text-sm ml-5">
                        ...
                        >
                            <a
                                class="bg-green-200 px-6 py-2 border border-transparent hover:border hover:-translate-y-1 flex items-center justify-center rounded-lg transition-transform duration-300"
                                :href="skill.url"
                                target="_blank"
                            >
        ...
        <div class="border border-gray-800 bg-secondary/10 p-5 rounded-lg w-full mt-10">
            ...
            <div class="flex flex-col md:flex-row gap-y-5 items-center justify-evenly">
                ...
                >
                    <div class="flex flex-col items-center">
                        <span class="text-white">{{ language.name }}</span>
